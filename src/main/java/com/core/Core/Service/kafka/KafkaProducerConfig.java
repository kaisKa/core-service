...
public class KafkaProducerConfig {
    ...
    private String BOOTSTARTPSERVERS;

    public Map<String,Object> producerConfig(){
        Map<String,Object> props = new HashMap<>();

        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, BOOTSTARTPSERVERS);
    ...
    @Bean
    public KafkaTemplate<String,Submission> kafkaTemplate(ProducerFactory<String, Submission> producerFactory){
